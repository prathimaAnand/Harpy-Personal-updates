...
B_swing(:,3)  = [k(1); k(2); k(3) + crouch_height/4]; % full crouching

B_swing(:,4)  = [k(1); k(2); k(3) + crouch_height*3/4]; 
...
% Bezier midpoint parameter
B_swing(:,2) = [k(1); k(2); k(3) + crouch_height/2];
B_swing(:,3)  = [k(1); k(2); k(3)]; 

% End state of 2nd bezier curve 

B_swing(:,4) = [k(1); k(2); k(3) - jump_height/2]; 
